 ...
 * All right reserved.
 */
package com.suncity.service.order.impl;
...
import com.suncity.dao.order.OrderMapper;
import com.suncity.model.order.Order;
import com.suncity.pub.constants.IMySystemConstants;
import com.suncity.pub.util.MyAutoGenerateOrderNum;
				...
				while (iter.hasNext()) {
					...
					if (file != null) {
						...
						if (myFileName.trim() != "") {
							...
							// order.setCover_img_url(IMySystemConstants.FILE_PATH_IMAGE
							// + fileName);
						}
					}
				}
