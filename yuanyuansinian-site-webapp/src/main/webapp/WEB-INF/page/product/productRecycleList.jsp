		...
		$(function() {
			...
			var oTable = $("#data_table")
					.DataTable(
							{
								ajax : {
									url : "${pageContext.request.contextPath}/sinian/content/contentController/queryContentRecycleList",
									type:"POST",
									data : {
										//args1: "固定传参"
									}
		...
		function toRecover(id){
			layer.confirm("确认恢复？", {
				  btn: ['确认','返回'] //按钮
						...
						$.ajax({
						    url: "${pageContext.request.contextPath}/sinian/content/contentController/recoverContent" ,
						    type: "POST",
						    dataType: "JSON",
						    data: {id:id},
