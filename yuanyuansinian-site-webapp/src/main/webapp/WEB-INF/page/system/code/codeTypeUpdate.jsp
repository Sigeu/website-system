...
<body class="pos-r">
		...
		<form id="form_"
			action="${pageContext.request.contextPath}/system/controller/codeTypeController/updateCodeType" class="form form-horizontal" 
			method="post">
			...
			<table style="width: 99%" class="table table-border table-bordered">
				<tr>
					...
					<td nowrap="nowrap"><input type="text" style="width: 90%;" placeholder="类别名称"
						id="type_name" name="type_name" value="${codeType.type_name }" class="input-text"/> 
						<font style="color: red">*</font></td>

					<td align="right" width="16%" nowrap="nowrap" class="text-r mybg">类别代码：</td>
					<td nowrap="nowrap">
					<input type="text"  style="width: 90%;"  placeholder="类别代码"
						id="code_type" name="code_type" value="${codeType.code_type }" class="input-text" />
				...
				<tr>
					...
					<td nowrap="nowrap"><div class="radio-box">
							<input type="radio" id="is_edit_y" name="is_edit" value="1" />
					...
					<td nowrap="nowrap">
					<div class="radio-box">
							<input type="radio" id="is_memory_y" name="is_memory" value="1" />
							<label for="sex_man">是</label>
						</div>
						<div class="radio-box">
...
$(function(){
	...
	$("input[name='is_edit'][value='${codeType.is_edit }']").attr("checked",true); 
	$("input[name='is_memory'][value='${codeType.is_memory }']").attr("checked",true); 
});
