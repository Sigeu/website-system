		...
		$(function() {
			...
			var oTable = $("#data_table")
					.DataTable(
							{
								ajax : {
									url : "${pageContext.request.contextPath}/sinian/content/contentController/queryContentList",
									type:"POST",
									data : {
										//args1: "固定传参"
									}
			...
			$('#add_but').on('click', function() {
				layer.open({
				    ...
				    content: '${pageContext.request.contextPath}/sinian/content/contentController/toContentAdd'
				 });
			});
