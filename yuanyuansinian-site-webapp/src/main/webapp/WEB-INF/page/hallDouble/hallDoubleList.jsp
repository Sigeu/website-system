...
<title>纪念馆-双人馆列表</title>
</head>
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>
		纪念馆管理 <span class="c-gray en">&gt;</span>双人馆管理
	</nav>
	<div id="win"></div>
	<div id="win2"></div>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var oTable = $("#data_table")
					.DataTable(
							{
								ajax : {
									url : "${pageContext.request.contextPath}/sinian/hallDouble/hallDoubleController/queryHallDoubleList",
									type:"POST",
									data : {
										//args1: "固定传参"
									}
		...
		function toDelete(id){
			layer.confirm("确认删除？", {
				  btn: ['确认','返回'] //按钮
						...
						$.ajax({
						    url: "${pageContext.request.contextPath}/sinian/hallDouble/hallDoubleController/deleteHallDouble" ,
						    type: "POST",
						    dataType: "JSON",
						    data: {id:id},
		...
		function toDetail(id){
			layer.open({
			    ...
			    content: '${pageContext.request.contextPath}/sinian/hallDouble/hallDoubleController/toHallDoubleDetail?id='+id
			 });
		}
