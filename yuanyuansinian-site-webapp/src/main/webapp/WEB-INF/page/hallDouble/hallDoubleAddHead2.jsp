...
<body class="pos-r">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<div id="uploader-demo">
				...
				<button id="head_but2" style="display: none"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/js/hallDouble-uploadHead2.js">
	</script>
	<script type="text/javascript">
		var serverUrl = '/sinian/hallDouble/hallDoubleController/uploadHead2';
		// 项目路径
