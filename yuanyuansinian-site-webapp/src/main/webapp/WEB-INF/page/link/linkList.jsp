	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var oTable = $("#data_table")
					.DataTable(
							{
								ajax : {
									url : "${pageContext.request.contextPath}/sinian/link/linkController/queryLinkList",
									type:"POST",
									data : {
										//args1: "固定传参"
									}
		...
		function toEdit(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/sinian/link/linkController/toLinkUpdate?id='+id
			 });
		}
		//删除
		function toDelete(id){
			layer.confirm("确认删除？", {
				  btn: ['确认','返回'] //按钮
						...
						$.ajax({
						    url: "${pageContext.request.contextPath}/sinian/link/linkController/deleteLink" ,
						    type: "POST",
						    dataType: "JSON",
						    data: {id:id},
		...
		function toDetail(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/sinian/link/linkController/toLinkDetail?id='+id
			 });
		}
