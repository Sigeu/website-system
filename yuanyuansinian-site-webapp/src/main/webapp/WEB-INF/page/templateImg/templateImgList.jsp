...
<body>
	<nav class="breadcrumb">
		...
		系统管理 <span class="c-gray en">&gt;</span>灵堂模版管理
	</nav>
	<div id="win"></div>
	<div id="win2"></div>
	<div data-options="fit:true" style="height: 100%">
		<div class="page-container">
			<table id="search_table" style="width: 95%;" border="0">
				<tr>
						<span>注：首页灵堂模版图片尺寸为1600*412</span>
						&nbsp;&nbsp;
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#add_but').on('click', function() {
				layer.open({
				    ...
				    content: '${pageContext.request.contextPath}/sinian/templateImg/templateImgController/toTemplateImgAdd'
				 });
			});
		...
		function toEdit(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/sinian/templateImg/templateImgController/toTemplateImgUpdate?id='+id
			 });
		}
		//删除
		function toDelete(id){
			layer.confirm("确认删除？", {
				  btn: ['确认','返回'] //按钮
						...
						$.ajax({
						    url: "${pageContext.request.contextPath}/sinian/templateImg/templateImgController/deleteTemplateImg" ,
						    type: "POST",
						    dataType: "JSON",
						    data: {id:id},
		...
		function toDetail(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/sinian/templateImg/templateImgController/toTemplateImgDetail?id='+id
			 });
		}
		//查看大图
		function toShowImg(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/sinian/templateImg/templateImgController/showImg?id=' + id
			 });
		}
	</script>
</body>
