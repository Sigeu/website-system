...
<body>
	...
	<div class="col-sm-9">
		<div class="web-info">
			<h3>缘园思念注册用户</h3>
			<p class="hidden-sm">注册时间：2016-12-30</p>
			<p class="hidden-sm">你已经在缘园思念网注册30天了，感谢您的支持</p>
		</div>
		<div class="true-info">
			<ul>
				<li class="pull-left"><span>姓名：</span>王富贵</li>
				<li class="pull-left"><span>性别：</span>男</li>
				<li class="pull-left"><span>出生日期：</span>2000-12-05</li>
				<li class="pull-left"><span>居住地：</span>北京</li>
				<li class="pull-left"><span>现住地：</span>山东济南</li>
			</ul>
		</div>
		<div class="clearfix"></div>
		<div class="count-info">
			<div class="product-price pull-left"><span class="btn-label pull-left">账户余额：</span><h2 class="pull-left"><small>￥</small>12.00</h2></div>
			<button class="btn btn-danger pull-left">立刻充值</button>
			<button class="btn btn-warning pull-left">创建纪念馆</button>
		</div>
	</div>
</div>
				...
				<div class="tab-pane img-list shop-list miss-list" id="release">
					...
					<div class="article">
						...
						<div class="article-body">
							...
							<p><img src="${pageContext.request.contextPath}/static/images/ex3.jpg" class="img-responsive" alt="img"></p>
							<p>清明节又叫踏青节，在仲春与暮春之交，也就是冬至后的第108天。是中国传统节日，也是最重要的祭祀节日之一，是祭祖和扫墓的日子。中华民族传统的清明节大约始于周代，距今已有二千五百多年的历史。</p>
						</div>
					</div>
					<!-- 文章内容结束 -->
