...
<body class="pos-r">
	...
	<div class="page-container">
		<form
			action="${pageContext.request.contextPath}/sinian/hall/hallController/updateHall"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.title }" placeholder="纪念馆名称"
						id="title" name="title">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="description" cols="" rows="" class="textarea"
						...
						onKeyUp="$.Huitextarealength(this,200)">${hall.description }</textarea>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input id="input_template" value="" class="input-text" placeholder="模版" type="text" style="cursor: pointer;" readonly="readonly" name="templateName">
		          	<input type="hidden" id="template_id" name="template_id" value="${hall.template_id }">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.alias }" placeholder="别名"
						id="alias" name="alias">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.name }" placeholder="姓名"
						id="name" name="name">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })"
						value="${hall.birthday }" placeholder="出生日期" id="birthday" name="birthday"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })"
						value="${hall.death_date }" placeholder="去世日期" id="death_date" name="death_date"
						class="input-text Wdate">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.nationality }" placeholder="国籍"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.birthplace }" placeholder="出生地"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.native_place }" placeholder="籍贯"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.nation }" placeholder="民族"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.address }" placeholder="墓地地址"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${hall.belief }" placeholder="信仰"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="achievement" cols="" rows="" class="textarea"
						...
						onKeyUp="$.Huitextarealength(this,500)">${hall.achievement }</textarea>
					<p class="textarea-numberbar">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<textarea name="life_story" cols="" rows="" class="textarea"
						placeholder="成就" dragonfly="true"
						onKeyUp="$.Huitextarealength(this,2000)">${hall.life_story }</textarea>
					<p class="textarea-numberbar">
	...
	$("#btn_select,#input_template").click(function(){
		...
		$(function() {
			$('#input[name=sex]').val('${hall.sex }');
			$('#input[name=open_type]').val('${hall.open_type }');
