...
<body class="pos-r">
	...
	<div class="container con-tab all-bg miss-con new-con">
		...
		<div class="new-body">
			...
			<form class="form-horizontal"
				action="${pageContext.request.contextPath}/sinian/hallDouble/hallDoubleController/updateHallDouble"
				method="post" id="form_">
				<div class="new-pro">
					<input type="hidden" name="hall_type" id="hall_type" value="2">
					<input type="hidden" name="id" id="id" value="${hallDouble.id }">
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2"><span
							class="c-red">*</span>纪念馆名称：</label>
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${hallDouble.title }"
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea name="life_story" cols="" rows="" class="textarea"
								...
								onKeyUp="$.Huitextarealength(this,2000)">${hallDouble.life_story }</textarea>
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入姓名" value="${hallDouble.name }"
								id="name" name="name">
						</div>
					</div>
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入别名" value="${hallDouble.alias }"
								id="alias" name="alias">
						</div>
					</div>
					<div class="form-group col-sm-6">
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8 col-sm-9">
							<input type="text"
								onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" value="${hallDouble.birthday }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${hallDouble.zodiac }" placeholder="生肖" readonly="readonly"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8 col-sm-9">
							<input type="text"
								onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" value="${hallDouble.death_date }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入国籍" value="${hallDouble.nationality }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入民族" value="${hallDouble.nation }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入墓地地址" value="${hallDouble.address }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入信仰" value="${hallDouble.belief }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入出生地" value="${hallDouble.birthplace }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入籍贯" value="${hallDouble.native_place }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<textarea name="achievement" cols="" rows="" class="textarea"
								placeholder="成就" dragonfly="true"
								onKeyUp="$.Huitextarealength(this,500)">${hallDouble.achievement }</textarea>
							<p class="textarea-numberbar">
				...
				<div class="new-pro">
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3"><span
							class="c-red">*</span>姓名</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入姓名" value="${hallDouble.name2 }"
								id="name2" name="name2">
						</div>
					</div>
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">别名</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入别名" value="${hallDouble.alias2 }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8 col-sm-9">
							<input type="text"
								onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" value="${hallDouble.birthday2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-xs-4 col-sm-3"><span
							class="c-red">*</span>生肖：</label>
						<div class="col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="${hallDouble.zodiac2 }" placeholder="生肖" readonly="readonly"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-xs-8 col-sm-9">
							<input type="text"
								onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" value="${hallDouble.death_date2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">国籍</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入国籍" value="${hallDouble.nationality2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">民族</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入民族" value="${hallDouble.nation2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">墓地地址</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入墓地地址" value="${hallDouble.address2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">信仰</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入信仰" value="${hallDouble.belief2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">出生地</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入出生地" value="${hallDouble.birthplace2 }"
					...
					<div class="form-group col-sm-6">
						<label class="control-label col-sm-4 col-md-3">籍贯</label>
						<div class="col-sm-8 col-md-9">
							<input type="text" class="form-control" placeholder="请输入籍贯" value="${hallDouble.native_place2 }"
					...
					<div class="form-group col-sm-6">
						...
						<div class="col-sm-8 col-md-9">
							<textarea name="achievement2" cols="" rows="" class="textarea"
								placeholder="成就" dragonfly="true"
								onKeyUp="$.Huitextarealength(this,500)">${hallDouble.achievement2 }</textarea>
							<p class="textarea-numberbar">
								<em class="textarea-length">0</em>/500
							</p>
						</div>
	...
	function getZodiac(year) {
		...
		$(function() {
			$('#input[name=sex]').val('${hallDouble.sex }');
			$('#input[name=open_type]').val('${hallDouble.open_type }');
			$('#input[name=sex2]').val('${hallDouble.sex2 }');
			//关闭按钮
