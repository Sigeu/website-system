	...
	<div class="container all-bg">
		...
		<div class="all-info img-list">
			<div class="pro-header">
				...
				<button class="btn btn-warning btn-xs btn-memorial">单人馆</button>
				<button class="btn btn-warning btn-xs btn-memorial">双人馆</button>
				<a href="###" class="more pull-right">更多&raquo;</a>
			</div>
			<div class="clearfix"></div>
			<div class="row">
				<div class="col-sm-4 col-md-3">
					<div class="thumbnail">
						<a href="###"><img src="images/ex3.jpg" class="img-responsive"
							alt="img"></a>
						<div class="caption">
							<a href="###"><h5>天束幽花</h5></a>
							<p>
				...
				<div class="col-sm-4 col-md-3">
					<div class="thumbnail">
						<a href="###"><img src="images/ex2.jpg" class="img-responsive"
							alt="img"></a>
						<div class="caption">
							<a href="###"><h5>天束幽花</h5></a>
							<p>
				...
				<div class="col-sm-4 col-md-3">
					<div class="thumbnail">
						<a href="###"><img src="images/slide1.png"
				...
				<div class="col-sm-4 col-md-3">
					<div class="thumbnail">
						<a href="###"><img src="images/slide2.png"
							class="img-responsive" alt="img"></a>
						<div class="caption">
							<a href="###"><h5>天束幽花</h5></a>
							<p>
				...
				<div class="col-sm-4 col-md-3">
					<div class="thumbnail">
						<a href="###"><img src="images/ex.jpg" class="img-responsive"
							alt="img"></a>
						<div class="caption">
							<a href="###"><h5>天束幽花</h5></a>
							<p>
