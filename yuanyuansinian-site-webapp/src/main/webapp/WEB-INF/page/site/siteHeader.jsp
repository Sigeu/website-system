...
<header class="navbar-static-top navbar-top">
	<div class="container">
		...
		<p class="navbar-text navbar-right"><a href="${pageContext.request.contextPath}/login.jsp" id="reg" class="navbar-link" style="color:#b85844">用户登录</a> | <a href="##" class="navbar-link" id="register_but1">用户注册</a> | <a href="${pageContext.request.contextPath}/contact.jsp" class="navbar-link">联系我们</a></p>
	</div>
</header>
