	...
	<div class="container all-bg museum">
		<div class="row museum-info">
			<div class="col-sm-4 col-md-3 museum-info-left">
				<img src="images/ex3.jpg" class="img-responsive" alt="museum" />
			...
			<div class="tab-content">
				...
				<div class="row tab-pane" id="album">
					...
					<div class="col-sm-4 col-md-3">
						<div class="thumbnail">
							<img src="images/slide3.png" class="img-responsive" alt="album" />
							<div class="caption">
					...
					<div class="col-sm-4 col-md-3">
						<div class="thumbnail">
							<img src="images/slide1.png" class="img-responsive" alt="album" />
							<div class="caption">
								<a href="###">天束幽花单独半身照</a>
							</div>
						</div>
					...
					<div class="col-sm-4 col-md-3">
						<div class="thumbnail">
							<img src="images/ex2.jpg" class="img-responsive" alt="album" />
							<div class="caption">
								<a href="###">天束幽花单独半身照</a>
							</div>
						</div>
					...
					<div class="col-sm-4 col-md-3">
						<div class="thumbnail">
							<img src="images/ex.jpg" class="img-responsive" alt="album" />
							<div class="caption">
								<a href="###">天束幽花单独半身照</a>
							</div>
						</div>
