		...
		if (state === 'uploading') {
			...
			var options = {
				success : function(data) {
					...
					//确保图片上传
					var zpiframe1 = $("#zpiframe1")[0].contentWindow;
					var zpiframe2 = $("#zpiframe2")[0].contentWindow;
					zpiframe1.toClickUpload(model_id);
					zpiframe2.toClickUpload(model_id);
					uploader.upload();
				}
			};
			// 准备form表单
