	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#add_but').on('click', function() {
				layer.open({
				    ...
				    content: '${pageContext.request.contextPath}/apply/controller/applyController/toApplyAdd'
				 });
			});
		...
		function toEdit(id){
			layer.open({
			    ...
			    area: ['100%', '100%'],
			    shadeClose: false, //点击遮罩关闭
			    content: '${pageContext.request.contextPath}/apply/controller/applyController/toApplyUpdate?id='+id
			 });
		}
		//删除
