...
<body class="pos-r">
	...
	<form action="${pageContext.request.contextPath}/content/controller/contentController/auditContent" method="post" class="form form-horizontal" id="form-content-update">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="submit_but" class="btn btn-secondary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 审核</button>
