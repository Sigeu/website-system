...
<body>
	...
	<script type="text/javascript">
		...
		$(function() {
			$.ajax({
				method : "POST",
				url : contextPath + "/index/controller/indexController/articleListForPage112",
				data : {
					//id : '${column_id }'
				}
			}).done(function(data) {
			    ...
			    "callBack":function(result){
			        ...
			        for(var i=0;i<result.length;i++){
			        	var cHtml_1 = "<div class='search-pro'><a href='###'  onclick=\"toContentDetail('" + result[i].id +"');return false;\"><h5>";
