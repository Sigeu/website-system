...
import ujn.school.cn.pub.util.IpAccessUtil;

/**
 * @Description: TODO
 * @author lizhaotao lzh_me@126.com
 * @date 2017年11月25日 下午5:03:29
 * @version V1.0
 */
public class IpAccessFilter implements Filter {
	 ...
	 */
	private static final int MIN_SAFE_TIME = 2000;
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
		...
		// 获取用户IP
		String ip = IpAccessUtil.getIpAddr(request);
		...
		if (isLimitedIP(limitedIpMap, ip)) {
			...
			request.getRequestDispatcher("/index/controller/indexController/ipAccessError").forward(request, response);
			return;
		}
		// 获取IP存储器
