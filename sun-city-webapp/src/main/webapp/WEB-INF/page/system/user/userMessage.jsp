...
<body class="pos-r">
		<nav class="breadcrumb">
			首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span>用户信息
		</nav>
	<div class="page-container">
	<form action="${pageContext.request.contextPath}/system/controller/userController/updateUser" method="post" class="form form-horizontal" id="form-user-message">
		<input type="hidden" name="id" id="id" value="${user.id}">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>登录名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.login_name}" readonly="readonly" id="login_name" name="login_name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">密码验证：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
$(function(){
	...
	$("#form-user-message").validate({
		...
		submitHandler:function(form){
			...
			// 准备form表单
			$("#form-user-message").ajaxForm(options);
