	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var oTable = $("#data_table")
					.DataTable(
							{
								ajax : {
									url : "${pageContext.request.contextPath}/sinian/audit/auditController/queryAuditContentList",
									type:"POST",
									data : {
										//args1: "固定传参"
									}
		...
		function toAudit(id){
			layer.open({
			    ...
			    content: '${pageContext.request.contextPath}/sinian/audit/auditController/toContentAudit?id='+id
			 });
		}
	</script>
</body>
